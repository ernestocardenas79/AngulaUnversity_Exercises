...
@NgModule({
  ...
  declarations: [CsfInputFaComponent, CsfInputDirective, CsfInputMdComponent, CsfTabPanelComponent, CsfTabComponent],
  exports: [CsfInputFaComponent, CsfInputDirective, CsfInputMdComponent, CsfTabPanelComponent, CsfTabComponent ]
})
